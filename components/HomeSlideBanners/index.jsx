  ...
  return (
    <>
      <div className="flex items-center justify-between px-2 py-0 mt-3">
        <h2 className="text-[22px] font-[600]">Home Slide Banner</h2>
        <div className="col w-[25%] ml-auto flex items-center justify-end gap-3">
          ...
          <Button
            className="!bg-blue-500  !btn-sm !btn !text-white flex items-center gap-1"
            onClick={() =>
...
export default HomeSlideBanners;
